...
class Slack {
    ...
    constructor (config) {
        ...
        this.rtmClient = new RtmClient(config.apiToken, {logLevel: config.logLevel});
    ...
    attachMessageHandlers () {
        this.rtmClient.on(RTM_EVENTS.MESSAGE, this.handleMessageEvent.bind(this));
        this.rtmClient.on(RTM_EVENTS.PRESENCE_CHANGE, this.handlePresenceChangeEvent.bind(this));
        this.rtmClient.on(RTM_EVENTS.DND_UPDATED, this.handleDndUpdatedEvent.bind(this));
        this.rtmClient.on(RTM_EVENTS.IM_MARKED, this.handleImMarkedEvent.bind(this));
        this.rtmClient.on(RTM_EVENTS.CHANNEL_MARKED, this.handleChannelMarkedEvent.bind(this));
    }
